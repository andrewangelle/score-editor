...
import { PDFPageStrip } from '#/components/pdf/PDFPageStrip';
import { RegionLayer } from '#/components/pdf/RegionLayer';
import { ScoreOverlay } from '#/components/pdf/ScoreOverlay';
