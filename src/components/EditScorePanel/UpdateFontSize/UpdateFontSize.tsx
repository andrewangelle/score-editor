...
export function UpdateFontSize() {
  ...
  return (
    <div className="mb-6">
      <p className={SUBSECTION_CLASS}>{FONT_SIZE_TEXT}</p>
      <div
        data-testid="UpdateFontSize"
      ...
      >
        ...
        <button
          ...
          disabled={
            !selectedAnnotationId || fontSize === selectedAnnotationSize
          }
